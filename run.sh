...
export MESSAGE="[$WERCKER_GIT_REPOSITORY:$WERCKER_GIT_BRANCH] pipeline <$WERCKER_RUN_URL|${WERCKER_SLACK_PIPELINE_NOTIFIER_PIPELINE} ${WERCKER_GIT_COMMIT:0:8}> by $WERCKER_STARTED_BY $WERCKER_RESULT"
export FALLBACK="[$WERCKER_GIT_REPOSITORY:$WERCKER_GIT_BRANCH] pipeline ${WERCKER_SLACK_PIPELINE_NOTIFIER_PIPELINE} ${WERCKER_GIT_COMMIT:0:8} by $WERCKER_STARTED_BY $WERCKER_RESULT"
export COLOR="good"
